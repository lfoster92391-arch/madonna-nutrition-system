...
function TeacherLunchActivityBody() {
...
function TeacherLunchActivityHeader({ onCollapse }: { onCollapse?: () => void }) {
  return (
    <div
  ...
  return (
    <>
        ...
        {!utilityRailExpanded ? (
          ...
          >
            <button
              ...
              className="flex min-h-11 min-w-11 items-center justify-center rounded-2xl transition hover:bg-[#0A1E3F]/5"
          ...
          <aside
            ...
            style={{ borderColor: TEACHER_SILVER, backgroundColor: "#FFFFFF" }}
          >
            <TeacherLunchActivityHeader onCollapse={collapse} />
            <TeacherLunchActivityBody />
          </aside>
        )}
      </div>
      ...
      <Sheet open={mobileRailOpen} onOpenChange={setMobileRailOpen}>
        <SheetContent
          side="right"
          className="flex h-full w-[min(20rem,90vw)] max-w-none flex-col gap-0 overflow-hidden p-0"
        >
          <SheetHeader className="sr-only">
            <SheetTitle style={{ color: TEACHER_NAVY }}>Today&apos;s Lunch Sign-Ups</SheetTitle>
            <SheetDescription>Students signed up for lunch today</SheetDescription>
          </SheetHeader>
          <TeacherLunchActivityHeader />
          <TeacherLunchActivityBody />
        </SheetContent>
      </Sheet>
    </>
