...
export function AccessHubClient({
  ...
  return (
    <LandingShell>
      ...
      <section
        className="landing-card-enter w-full min-w-0 max-w-xl mx-auto"
            ...
            return (
              <div key={choice.key} className="min-w-0" role="listitem">
                <button
                  ...
                  className={cn(
                    "madonna-option-btn madonna-option-btn--rounded flex w-full min-h-14 items-center gap-3 px-4 py-3 text-left sm:min-h-16 sm:px-5",
                    isOpen && "madonna-option-btn--active"
                  )}
                >
                  <span
                  ...
                  <span className="min-w-0 flex-1 text-[15px] font-bold leading-tight sm:text-base">
                    {choice.label}
                  </span>
                  <ChevronDown
                    className={cn(
                      "h-5 w-5 shrink-0 text-white/85 transition-transform",
                      isOpen && "rotate-180"
                    )}
                    aria-hidden
                  />
                ...
                {isOpen ? (
                  <div
                    id={panelId}
                    className="mt-2 rounded-2xl border border-[#041B52]/12 bg-white/92 p-3 shadow-[0_6px_18px_rgba(4,27,82,0.12)] backdrop-blur-md sm:p-4"
                  ...
                  >
                    {choice.href ? (
                      <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
                        <Link
                          href={choice.href}
                          className="madonna-option-btn madonna-option-btn--pill inline-flex min-h-11 w-full items-center justify-center px-5 text-sm font-bold sm:w-auto sm:min-w-[180px]"
                        >
                        ...
                        {choice.secondaryHref && choice.secondaryLabel ? (
                          <Link
                            ...
                            className="inline-flex min-h-11 w-full items-center justify-center rounded-full border-2 bg-white px-5 text-sm font-bold transition hover:bg-white/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#041B52] focus-visible:ring-offset-2 sm:w-auto"
                            style={{ color: NAVY, borderColor: NAVY }}
                          >
