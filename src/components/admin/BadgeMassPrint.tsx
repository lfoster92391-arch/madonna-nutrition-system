...
export function BadgeMassPrint({ students, onClose }: BadgeMassPrintProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="badge-print-controls no-print flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-silver/60 bg-white p-4 shadow-sm">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button size="lg" onClick={handlePrint} disabled={sorted.length === 0}>
      ...
      {sorted.length === 0 ? (
        ...
        <div
          ref={printRef}
          className="badge-print-sheet rounded-2xl border border-silver/40 bg-white p-4 shadow-sm print:rounded-none print:border-0 print:p-0 print:shadow-none"
        >
